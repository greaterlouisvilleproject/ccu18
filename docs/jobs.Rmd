...
graph_trendline_change(high_wage,
                 'per_high_wage',
                 plot_title = 'Percentage of High Wage Jobs')
```
...
Inmigration and Outmigration are NOT currently adjusted for population size. I will adjust those numbers to percents to make this graph peer city comparable. I included it now to get a sense of inmigration and outmigration.
```{r graph29.3}
data$out_bach_plus = data$out_bach_plus * -1

graph_trendline_mig(data, 
