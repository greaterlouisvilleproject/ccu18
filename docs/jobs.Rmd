...
earn_data <- earn_data %>%
  ...
  mutate(median_earnings = as.numeric(as.character(median_earnings)),
         median_earnings_male = as.numeric(as.character(median_earnings_male)),
         median_earnings_female = as.numeric(as.character(median_earnings_female)),
...
data %<>% mutate_at(vars(median_earnings, median_earnings_male, median_earnings_female), rpp_col_adj)
...
## 4. Businesses per Resident Change
```{r graph14.12}
make_map_zip("businesses_per_resident_change_5yr", 
             name = "Businesses per Resident",
             legend_title = "Businesses<br/>per res",
             units = "Percent",
             map_style = "divergent")
...
```{r data15.2}
#White
unemp_white <- acs_time("/data/jobs/B23002-3year/B23002H/", starting_year = 2006)
...
#Black
unemp_black <- acs_time("/data/jobs/B23002-3year/B23002B/", starting_year = 2006)
