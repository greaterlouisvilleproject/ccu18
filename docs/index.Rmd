...
graph_trendline_race(
  ...
  xmin = 2006,
  xmax = 2015,
  plot_title = "Bachelor Degrees or Higher by Ethnicity, Ages 25-64",
...
graph_trendline(data,
                'bach_plus_per_gap',
                'Bachelor Degree Gap: White and Black Residents',
                subtitle_text = 'Ages 25-64, ',
                rollmean = 3,
...
```{r graph6.3}
data %<>%
  mutate(assoc_plus_per_gap = assoc_plus_per_white - assoc_plus_per_black)

graph_trendline(data,
                'assoc_plus_per_gap',
                'Associate Degree Gap: White and Black Residents',
                subtitle_text = 'Ages 25-64, ',
                rollmean = 3,
                y_title = "Percentage Points")
```
...
rank_and_nb_group(data[data$year == 2016,],
                  ...
                  plot_title = 'Associate Degrees or Higher, Ages 25-34')
...
data %<>% full_join(cert_df, by = c('FIPS', 'year'))
